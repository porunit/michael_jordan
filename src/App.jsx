...
import './App.css';  // Предполагая, что ваш CSS сохранен в файле с именем App.css
    ...
    <div>
      <div
        ...
        style={{
          ...
          top: '50%',
          position: 'absolute',
          transform: `translate(-50%, -50%) translateX(${percentage}%)`,  // Для центрирования
        }}
        ...
        {images.map((src, index) => (
          <img
            ...
            style={{
              ...
              height: '56vmin',
              objectFit: 'cover',
              objectPosition: `${50 - percentage / 2}% center`, // Динамическое изменение позиции изображения
